...
import { CodeEditorLayout } from './Layout/CodeEditorLayout'
...
function AppIcon({
  ...
  return (
    <div
      className={
        'inline-flex flex-col items-center justify-center p-1 px-3 mr-2 transition-all duration-500 ' +
        (st.tabAt === name
...
export function CodeEditor() {
  ...
  return (
    <div className='w-full h-full'>
      <div className='flex items-center px-5 from-gray-300 bg-gradient-to-t' style={{ height: `4.5rem` }}>
        {/*  */}
